...
public final class WmsServ {
	...
	private static List<String> getInitDevliveryInfo(String cusId,
	...
	public static List<Map<String, Object>> getSendDeliveryInfo(String expressId) {
		...
		switch (expressId) {
		case "JD":
			sql = "SELECT [deliveryId]" + ",[salePlat]" + ",[customerCode]"
					+ ",[orderId]" + ",[thrOrderId]" + ",[selfPrintWayBill]"
					+ ",[pickMethod]" + ",[packageRequired]" + ",[senderName]"
					+ ",[senderAddress]" + ",[senderTel]" + ",[senderMobile]"
					+ ",[senderPostcode]" + ",[receiveName]"
					+ ",[receiveAddress]" + ",[province]" + ",[city]"
					+ ",[county]" + ",[town]" + ",[provinceId]" + ",[cityId]"
					+ ",[countyId]" + ",[townId]" + ",[siteType]" + ",[siteId]"
					+ ",[siteName]" + ",[receiveTel]" + ",[receiveMobile]"
					+ ",[postcode]" + ",[packageCount]" + ",[weight]"
					+ ",[vloumLong]" + ",[vloumWidth]" + ",[vloumHeight]"
					+ ",[vloumn]" + ",[description]" + ",[collectionValue]"
					+ ",[collectionMoney]" + ",[guaranteeValue]"
					+ ",[guaranteeValueAmount]" + ",[signReturn]" + ",[aging]"
					+ ",[transType]" + ",[remark]" + ",[goodsType]"
					+ ",[orderType]" + ",[shopCode]" + ",[orderSendTime]"
					+ ",[warehouseCode]" + ",[extendField1]"
					+ ",[extendField2]" + ",[extendField3]" + ",[extendField4]"
					+ ",[extendField5]" + " FROM [idx_jdexpress_getorder]";
			break;
		case "ZTO":
